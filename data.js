...
var archiveData = {
    "2026-03-30": {
        ...
        main: {
            ...
            link: "https://www.econovill.com/news/articleView.html?idxno=734918",
            source: "이코노믹리뷰",
            insight: "현대차의 렌터카 직진출은 제조를 넘어선 플랫폼 통합 전략입니다. 당사의 기존 렌터카 비즈니스 및 글로벌 플랫폼과 연계하여 데이터 분석 시스템 고도화가 시급합니다."
        },
        // 💡 다양한 매체로 재구성된 AI 파트
        ai: [
                       { 
        ...
        auto: [
            { 
                isImportant: true,
                brand: "케이카", 
                title: "케이카, 2026년 기업가치 제고 계획 공개", 
                desc: "직영 네트워크 확대 및 C2C 안심직거래 베타 추진 등 기업가치 제고 및 주주환원 정책을 발표했습니다.", 
            ...
            { brand: "엔카", title: "성수 팝업 '엔카라지' 성료... MZ세대 1만 명 방문", desc: "중고차 거래 전 과정을 오프라인 체험으로 풀어낸 혁신 사례입니다.", img: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=400", link: "https://www.mk.co.kr/news/business/11997601", source: "매일경제" },
            { brand: "쏘카", title: "프리미엄 '블랙라벨' 100대 확충... 수익성 강화", desc: "수입차 및 고급 세단 중심의 라인업 확대로 법인 및 장거리 수요를 선점했습니다.", img: "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=400", link: "https://platum.kr/archives/283833", source: "플래텀" }
        ]
    }
};
        auto: [
